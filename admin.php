      ...
      <body>
        ...
        <center>
          ...
          <h2>Sistema de login com Cookies</h2>
            ...
            <a style="background-color: #000; color: #fff; padding: 5px 50px 5px 50px; text-decoration: none; border-radius: 0.3em; outline: none; cursor: pointer;" href='./admin.php?acao=destruir'>
              Sair
            </a>
